...
   k1=dt*a
   l1=dt*v
   a=-(x+l1/2.d0)-(v+k1/2.0)+sin(wf*(t+0.5*dt))
   k2=dt*a
   l2=dt*(v+k1/2.d0)
   a=-(x+l2/2.d0)-(v+k2/2.0)+sin(wf*(t+0.5*dt))
   k3=dt*a
   l3=dt*(v+k2/2.d0)
   a=-(x+l3)-(v+k3)+sin(wf*(t+0.5*dt))
   k4=dt*a
   l4=dt*(v+k3)
   v=v+(k1+2.d0*k2+2.d0*k3+k4)/6.d0
   x=x+(l1+2.d0*l2+2.d0*l3+l4)/6.d0
   e=0.5d0*x**2+0.5d0v**2
   t=dt+t
end
